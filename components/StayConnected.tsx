...
const StayUpdated = () => {
  return (
    <div className="flex flex-col gap-4 md:flex-row justify-between items-center bg-black text-white p-4 rounded-xl shadow-md">
      ...
      <div className="flex items-center gap-2 w-full rounded-full p-1 justify-between bg-white text-black">
        <input
          type="email"
          placeholder="Email Address*"
          className="px-4 py-2 bg-transparent outline-none "
        />
        <button className="md:px-6 text-xs px-4 py-2 flex justify-end bg-slate-200 text-balck rounded-full hover:bg-purple-600">
          Get Connected
        </button>
      </div>
    </div>
